...
public class WxFeedbackController {
    ...
    @PostMapping("submit")
    @ApiOperation("意见反馈")
    public Object submit(@LoginUser @ApiIgnore Integer userId,
                         @RequestBody @ApiParam("参数：content，feedType，hasPicture,mobile") LitemallFeedback feedback) {
        if (userId == null) {
