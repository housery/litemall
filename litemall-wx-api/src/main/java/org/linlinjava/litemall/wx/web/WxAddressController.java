...
@Validated
@Api(value = "用户收货地址服务",tags = "用户收货地址服务")
public class WxAddressController {
    ...
    @GetMapping("detail")
    @ApiOperation("收货地址详情")
    public Object detail(@LoginUser Integer userId, @ApiParam("收货地址ID") @NotNull Integer id) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
    ...
    public Object save(@LoginUser Integer userId,
                       @ApiParam("参数：name,mobile,provinceId,cityId,areaId,address,isDefault(是否默认地址)")
                       @RequestBody LitemallAddress address) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
    ...
    public Object delete(@LoginUser Integer userId,
                         @ApiParam("参数：id(地址id)") @RequestBody LitemallAddress address) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
